...
namespace WarehouseGameplay.ViewModels
{
    public class MergeSortQuestionViewModel: INotifyPropertyChanged
    {
        ...
        private List<MergeSortQuiz> _questionList;
        List<Models.MergeSortQuiz> QuestionList {
        ...
        public MergeSortQuestionViewModel()
        {
            //LoadQuestions();
        }
        ...
        public Task LoadQuestions()
        {
            ...
            try
            {
                QuestionList =  AllQuiz.MergeSorQuizzes();
            }
            catch (Exception exc)
            {
                Debug.WriteLine(exc);
        ...
        public void ChooseNewQuestion()
        {
            ...
            Models.MergeSortQuiz selectedItem = QuestionList[_questionNumber];
            next++;
