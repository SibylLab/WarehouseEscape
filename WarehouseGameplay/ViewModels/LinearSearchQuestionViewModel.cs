...
{
    public class LinearSearchQuestionViewModel : INotifyPropertyChanged
    {
        ...
        private List<LinearSearchQuiz> _questionList;
        List<Models.LinearSearchQuiz> QuestionList
        {
        ...
        public LinearSearchQuestionViewModel()
        {
        ...
        public Task LoadQuestions()
        {
            ...
            try
            {
                QuestionList = AllQuiz.LinearSearchQuizzes();
            }
            catch (Exception exc)
            {
                Debug.WriteLine(exc);
        ...
        public void ChooseNewQuestion()
        {
            ...
            Models.LinearSearchQuiz selectedItem = QuestionList[_questionNumber];
            next++;
            Answer1Enabled = true;
            Answer2Enabled = true;
            Answer3Enabled = true;
