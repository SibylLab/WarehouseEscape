...
{
    public class InsertionSortQuestionViewModel : INotifyPropertyChanged
    {
        ...
        private List<InertionSortQuiz> _questionList;
        List<Models.InertionSortQuiz> QuestionList {
            get
            {
        ...
        public InsertionSortQuestionViewModel()
        {
            //LoadQuestions();
        }
        ...
        public Task LoadQuestions()
        {
            ...
            try
            {
                QuestionList = AllQuiz.InertionSortQuizzes();
            }
            catch (Exception exc)
            {
                Debug.WriteLine(exc);
        ...
        public void ChooseNewQuestion()
        {
            ...
            Models.InertionSortQuiz selectedItem = QuestionList[_questionNumber];
            next++;
