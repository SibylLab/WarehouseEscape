...
{
    public class BinarySearchQuestionViewModel : INotifyPropertyChanged
    {
        ...
        private List<BinearySearchQuiz> _questionList;
        List<Models.BinearySearchQuiz> QuestionList
        {
        ...
        public BinarySearchQuestionViewModel()
        {
            //LoadQuestions();
        }
        ...
        public Task LoadQuestions()
        {
            ...
            try
            {
                QuestionList = AllQuiz.BinarySearchQuizzes();
            }
            catch (Exception exc)
            {
                Debug.WriteLine(exc);
        ...
        public void ChooseNewQuestion()
        {
            ...
            Models.BinearySearchQuiz selectedItem = QuestionList[_questionNumber];
            next ++;
            Answer1Enabled = true;
            Answer2Enabled = true;
            Answer3Enabled = true;
