...
{
    public class QuickSortQuestionViewModel : INotifyPropertyChanged
    {
        ...
        private List<QuickSortQuiz> _questionList;
        List<Models.QuickSortQuiz> QuestionList {
            get
            {
        ...
        public QuickSortQuestionViewModel()
        {
            //LoadQuestions();
        }
        ...
        public Task LoadQuestions()
        {
            ...
            try
            {
                QuestionList = AllQuiz.QuickSortQuizzes();
            }
            catch (Exception exc)
            {
                Debug.WriteLine(exc);
        ...
        public void ChooseNewQuestion()
        {
            ...
            Models.QuickSortQuiz selectedItem = QuestionList[_questionNumber];
            next++;
